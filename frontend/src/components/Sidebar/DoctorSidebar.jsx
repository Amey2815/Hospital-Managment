  ...
  const menuItems = [
    {
      ...
      icon: <FaUserMd />,
      subItems: [
        { title: 'Add Doctor', icon: <FaPlus />, link: '/doctoradd' },
        { title: 'Manage Doctors', icon: <FaListUl />, link: '/doctorview' }
      ]
    },
    {
      title: 'Appointment',
      icon: <FaCalendarAlt />,
      subItems: [
        { title: 'View Appointments', icon: <FaListUl />, link: '/docview' },
        { title: 'Schedule', icon: <FaPlus />, link: '/docshedule' }
      ]
    },
